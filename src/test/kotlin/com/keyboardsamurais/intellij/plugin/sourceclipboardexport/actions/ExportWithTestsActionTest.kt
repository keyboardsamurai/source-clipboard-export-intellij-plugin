...
class ExportWithTestsActionTest {
    
    private lateinit var action: ExportWithTestsAction
    ...
    fun `test action presentation text and description`() {
        assert(action.templatePresentation.text == "Include Tests")
        assert(action.templatePresentation.description == "Export selected files with their test files")
    }
